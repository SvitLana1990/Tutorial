...
// 11.Заміни оголошення функції filterArray() і колбек для методу forEach() на стрілочні функції.
...
// const totalPlayTime = playtimes.reduce((previousValue, currentValue) => {
...
//   return users.reduce(
//     (previousValue, user) => previousValue + user.friends.length,
//     0
//   );
// };
...
//     .flatMap((userName) => userName.friends)
//     .filter((nameUser, index, array) => array.indexOf(nameUser) === index)
//     .sort((firstNameUser, secondNameUser) =>
//       firstNameUser.localeCompare(secondNameUser)
//     );
//   return usersCopy;
// };
